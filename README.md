...
### <img src="https://latex.codecogs.com/svg.image?{\color{white}y[n]&space;=&space;\sum_{l=0}^{M}r^{l}w[n-l](FIR&space;Filter&space;2)&space;}" title="https://latex.codecogs.com/svg.image?{\color{white}y[n] = \sum_{l=0}^{M}r^{l}w[n-l](FIR Filter 2) }" />
